...
<task type="auto">
  ...
  <done>KableBleRepository uses extracted parsers, utility functions (lines 2634-2683: getUInt16LE, getInt16LE, getUInt16BE, getInt32LE, getFloatLE, toHexString) removed, build passes</done>
</task>
