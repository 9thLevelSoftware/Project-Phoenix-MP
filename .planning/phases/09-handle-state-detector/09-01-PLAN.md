...
<feature>
  ...
  <implementation>
    ...
    **Step 2 - GREEN: Implement HandleStateDetector to make all tests pass.**
    ...
    **Step 3 - REFACTOR (if needed): Clean up without breaking tests.**

    Review for any cleanup opportunities (extract constants, improve naming, reduce duplication).
