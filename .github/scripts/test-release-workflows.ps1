...
Assert-Contains '.github/workflows/release-all.yml' 'needs: \[create-release, android-apk\]' 'Play Store publication is not gated on the Android asset.'
Assert-Contains '.github/workflows/release-all.yml' 'needs: \[create-release, ios-ipa\]' 'TestFlight publication is not gated on the iOS asset.'
