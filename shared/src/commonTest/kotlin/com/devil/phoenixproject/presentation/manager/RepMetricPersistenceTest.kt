...
class RepMetricPersistenceTest {
    ...
    private fun createTestRepMetricData(repNumber: Int, isWarmup: Boolean = false): RepMetricData = RepMetricData(
        repNumber = repNumber,
        isWarmup = isWarmup,
    ...
    fun `rep metrics not persisted when accumulation list is empty`() = runTest {
        ...
        assertTrue(
            ...
            "No rep metrics should be saved when none were accumulated",
        )
    ...
    fun `persisted rep metric count matches accumulated count`() = runTest {
        ...
        assertEquals(
            ...
            savedCount,
            "Persisted count should match accumulated count",
        )
