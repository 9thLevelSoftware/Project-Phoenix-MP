...
class BlePacketFactoryTest {
    ...
    /**
     * KD-9 made the builders' ceiling required, so nothing can guess it. Cases that are not
     * about the ceiling use the Trainer+ bound, which is the widest real hardware.
     */
