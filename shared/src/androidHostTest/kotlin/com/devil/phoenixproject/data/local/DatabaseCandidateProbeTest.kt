...
class DatabaseCandidateProbeTest {
    ...
    fun anyUserRowMakesTheCandidateHoldUserData() {
        val cases = mapOf(
            ...
            "recoloured default profile" to "UPDATE UserProfile SET colorIndex = 3 WHERE id = 'default'",
            "default profile subscription" to "UPDATE UserProfile SET subscription_status = 'premium' WHERE id = 'default'",
            "default profile subscription expiry" to "UPDATE UserProfile SET subscription_expires_at = 5 WHERE id = 'default'",
            "default profile sign-in" to "UPDATE UserProfile SET last_auth_at = 5 WHERE id = 'default'",
